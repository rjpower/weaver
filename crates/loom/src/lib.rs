...
//! the Vue web UI, the monitor loop, periodic summarization, and recently-used
//! repository bookkeeping. The agent-facing `weaver` CLI does not depend on
//! loom; running loom is purely additive.
